...
function updateUI()
{
  ...
  switch(local)
  {
    case 0:
      ...
      document.getElementById("btn6").setAttribute('href', serverip+'1_3_top_hover.png');
      document.getElementById("btn7").setAttribute('href', serverip+'1_3_bot_hover.png');
      document.getElementById("btn4").setAttribute('href', serverip+'1_2_bip_hover.png');
      document.getElementById("btn5").setAttribute('href', serverip+'1_2_bop_hover.png');
      document.getElementById("led4").setAttribute("href", serverip+"yellow_off.png");
      document.getElementById("led5").setAttribute("href", serverip+"yellow_off.png");
      break;
    case 1:
      document.getElementById("led0").setAttribute("href", serverip+"green_on.png");
      document.getElementById("led1").setAttribute("href", serverip+"green_off.png");
      document.getElementById("btn6").setAttribute('href', serverip+'1_3_top_on.png');
      document.getElementById("btn7").setAttribute('href', serverip+'1_3_bot_hover.png');
      document.getElementById("btn4").setAttribute('href', serverip+'1_2_bip_hover.png');
      document.getElementById("btn5").setAttribute('href', serverip+'1_2_bop_hover.png');
      document.getElementById("led4").setAttribute("href", serverip+"yellow_off.png");
    ...
    case 2:
      ...
      document.getElementById("btn6").setAttribute('href', serverip+'1_3_top_hover.png');
      document.getElementById("btn7").setAttribute('href', serverip+'1_3_bot_on.png');
      document.getElementById("btn4").setAttribute('href', serverip+'1_2_bip_hover.png');
      document.getElementById("btn5").setAttribute('href', serverip+'1_2_bop_hover.png');
      document.getElementById("led4").setAttribute("href", serverip+"yellow_off.png");
      document.getElementById("led5").setAttribute("href", serverip+"yellow_off.png");
    ...
    case 4:
      ...
      document.getElementById("btn6").setAttribute('href', serverip+'1_3_top_on.png');
      document.getElementById("btn7").setAttribute('href', serverip+'1_3_bot_on.png');
      document.getElementById("led4").setAttribute("href", serverip+"yellow_on.png");
      document.getElementById("led5").setAttribute("href", serverip+"yellow_off.png");
      document.getElementById("btn4").setAttribute('href', serverip+'1_2_bip_on.png');
      document.getElementById("btn5").setAttribute('href', serverip+'1_2_bop_hover.png');
      break;
    case 8:
      document.getElementById("led0").setAttribute("href", serverip+"green_on.png");
      ...
      document.getElementById("btn7").setAttribute('href', serverip+'1_3_bot_on.png');
      document.getElementById("led4").setAttribute("href", serverip+"yellow_off.png");
      document.getElementById("led5").setAttribute("href", serverip+"yellow_on.png");
      document.getElementById("btn4").setAttribute('href', serverip+'1_2_bip_hover.png');
      document.getElementById("btn5").setAttribute('href', serverip+'1_2_bop_on.png');
      break;
  }
}
...
{
	loadData("imp_1_2_"+config.myid);
}

function storeLocal()
{
	storeData("imp_1_2_"+config.myid);
}

function deleteLocal()
{
	deleteData("imp_1_2_"+config.myid);
}
...
function init()
{
  ...
  {    
    ...
    let newDomain = "http://"+config.Ip+"/I1to88?t=1_2&ptd=http://logic.qro.cz/logic/EasyControl/dominator.php&"+parts[1];
