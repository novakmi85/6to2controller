...
{
	loadData("imp_6to1_"+config.myid);
}

function storeLocal()
{
	storeData("imp_6to1_"+config.myid);
}

function deleteLocal()
{
	deleteData("imp_6to1_"+config.myid);
}
...
function init()
{
  ...
  {    
    ...
    let newDomain = "http://"+config.Ip+"/I1to88?t=6to1&ptd=http://logic.qro.cz/logic/EasyControl/dominator.php&"+parts[1];
